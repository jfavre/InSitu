...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      meshpvd = coprocessor.CreateProducer(datadescription, 'input')
      ...
      # setup the color legend parameters for each legend in this view1.0# get color legend/bar for temperatureLUT in view renderView1
